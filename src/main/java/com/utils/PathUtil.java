...
/**
 * Created by zhangxn on 2018/5/18.
 */
public class PathUtil {
    ...
    public static String getClasspath1() {
        String path = (String.valueOf(Thread.currentThread().getContextClassLoader().getResource("")) + "temp/").replaceAll("file:/", "").replaceAll("%20", " ").trim();
        if (path.indexOf(":") != 1) {
            path = File.separator + path;
        }
        return path;
