...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add">
        ...
        <#list modelItemForEditList as var>
             <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>${var[0]}：</label>
                 <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${var[1]}" placeholder="${var[0]}" id="${var[0]}" name="${var[0]}">
            </div>
        </#list>
    ...
    $(function(){
        ...
        $("#form-admin-add").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    type: 'post',
                    url: "${r'${ctx}'}/${lastPackageName}/${modelValue}/save?oper=edit" ,
